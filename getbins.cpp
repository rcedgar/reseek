...
BIN_T(NbrDist, 0, 4.417);
BIN_T(NbrDist, 1, 4.647);
BIN_T(NbrDist, 2, 4.841);
BIN_T(NbrDist, 3, 5.052);
BIN_T(NbrDist, 4, 5.286);
BIN_T(NbrDist, 5, 5.589);
BIN_T(NbrDist, 6, 6.055);
BIN_T(NbrDist, 7, 6.536);
BIN_T(NbrDist, 8, 7.007);
BIN_T(NbrDist, 9, 7.485);
BIN_T(NbrDist, 10, 7.999);
BIN_T(NbrDist, 11, 8.559);
BIN_T(NbrDist, 12, 9.166);
BIN_T(NbrDist, 13, 9.873);
BIN_T(NbrDist, 14, 11.18);

BIN_T(RevNbrDist, 0, 6);
BIN_T(RevNbrDist, 1, 7);
BIN_T(RevNbrDist, 2, 8);
BIN_T(RevNbrDist, 3, 9);
BIN_T(RevNbrDist, 4, 10);
BIN_T(RevNbrDist, 5, 11);
BIN_T(RevNbrDist, 6, 12);
BIN_T(RevNbrDist, 7, 13);
BIN_T(RevNbrDist, 8, 14);
BIN_T(RevNbrDist, 9, 15);
BIN_T(RevNbrDist, 10, 16);
BIN_T(RevNbrDist, 11, 17);
BIN_T(RevNbrDist, 12, 18);
BIN_T(RevNbrDist, 13, 19);
BIN_T(RevNbrDist, 14, 20);
