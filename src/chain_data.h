...
static const uint32_t bit_mega_pssm =			(1 << 1);
static const uint32_t bit_mega_pssm_rev =		(1 << 2);
static const uint32_t bit_mega_prof =			(1 << 3);
static const uint32_t bit_mega_prof_rev =		(1 << 4);
...
public:
	...
	static size_t get_bytes_per_pos(uint32_t bits);
