...
"    reseek -search STRUCTS -db STRUCTS [-dbmu db_mu.fasta] -output hits.txt\n"
"                 # STRUCTS specifies structure(s), see below\n"
"                 # db_mu.fasta is Mu fasta for faster search of large dbs\n"
"\n"
...
"\n"
"    reseek -convert2mu STRUCTS -fasta mu.fasta\n"
"                 # Convert structures to Mu FASTA (36-letter alphabet)\n"
"                 # Accelerates search with -db_mu option\n"
"\n"
